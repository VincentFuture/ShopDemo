<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyOrders.aspx.cs" Inherits="ShopDemo.PTUsers.PurchasePro.MyOrders" %>
            ...
            <ul class="BHeaderl">
                ...
                <%  //从session域中取出当前登录的用户
                    ...
                    if (user == null)
                    {
                        ...
                        %><span  style="color:#ea4949; width:20px;"><%=user.UserName %></span>
                 <% } %>
                </li>
                <!--<li><a href="#">登录</a> </li>-->
    ...
    <div class="member-center clearfix">
        <div class="member-left fl">
            <div class="member-apart clearfix">
                <div class="fl"><a href="#"><img src="../../theme/img/bg/mem.jpg" alt="" /></a></div>
                <div class="fl">
                    <p>用户名：</p>
                    <p><a href="#" style=" font-size:xx-small"><%=user.UserName %></a></p>
                    <p>我的邮箱：</p>
            ...
            <div class="member-border">
               <div class="member-return H-over">
                   ...
                   <div class="member-sheet clearfix">
                       ...
                       <ul>
                           <%
                               //创建订单信息List集合对象，并从session域中获取数据
                               List<OrderInfo> orderInfos = (List<OrderInfo>)Session["oiList"];
                               int oID = 0;
                               if (orderInfos.Count != 0)
                               {
                                   //该用户存在订单信息
                                   foreach (OrderInfo oif in orderInfos)
                                   {
                                       //判断新的订单号
                                       if (oif.OrderID != oID)
                                       {
                                           ...
                                           <li>
                                               ...
                                               <div class="member-minute clearfix">
                                                   <span><%=oif.CreateTime %></span>
                                                   <span>订单号：<em><%=oif.OrderID %></em></span>
                                                   <span><a href="Category.aspx">迪乐多图书旗舰店</a></span>
                                                   <span class="member-custom">客服电话：<em>010-6666-8888</em></span>
                                               </div>
                                               <!---->
                                               <!--该条订单的尾信息-->
                                               <div class="member-circle clearfix">
                                                   <div class="ci1">
                                                       <!--遍历某条订单的商品-->
                                                        <%
                                                            foreach(OrderInfo oig in orderInfos)
                                                            {
                                                                //判断该条商品是否属于本条订单
                                                                if (oig.OrderID == oID)
                                                                {
                                                                    ...
                                                                    <div class="ci7 clearfix">
                                                                       <span class="gr1"><a href="#"><img src="../../<%=oig.Thumbnail %>" width="60" height="60" title="" about=""></a></span>
                                                                       <span class="gr2"><a href="#"><%=oig.GoodsName %></a></span>
                                                                       <span class="gr3">X<%=oig.GoodsNumber %></span>
                                                                    </div>
                                                   ...
                                                   <div class="ci3"><b>￥<%=oif.OrderPay %></b><p>货到付款</p><p class="iphone">手机订单</p></div>
                               ...
                               <li><p style=" display:inline; width:auto; color:Red; font-size:x-large;">哎呀你还没有任何订单呢！</p></li>
                               <% }%>
                       </ul>
                   </div>
                   </div>
