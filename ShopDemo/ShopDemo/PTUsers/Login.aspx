<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ShopDemo.PTUsers.Login" %>
...
<head>
    ...
    <script src="../theme/js/checkcode.js" type="text/javascript"></script>
</head>
<body>
<div class="w">
	<div id="logo">
...
<div id="content" >
  ...
  <form action="" id="formlogin" runat="server" method="post" onsubmit="">
  	<div class="w">
                   ...
                   <%=error %>
  			  	<div class="form">
  			  			...
  			  			<div class="item item-fore1 item-error">
  			  				...
  			  				<asp:TextBox ID="loginname" name="loginname" runat="server" class="itxt" tabindex="1" autocomplete="off" placeholder="用户邮箱" TextMode="SingleLine"></asp:TextBox>
                            ...
                            <asp:TextBox ID="nloginpwd" runat="server" name="nloginpwd" class="itxt itxt-error" tabindex="2" autocomplete="off" placeholder="密码" TextMode="Password"></asp:TextBox>
                        ...
                        <div class="item item-fore5">
                        	<div class="login-btn">
                                <asp:Button ID="loginsubmit" runat="server" Text="登&nbsp;&nbsp;&nbsp;&nbsp;录" 
                                    class="btn-img btn-entry" tabindex="6" onclick="loginsubmit_Click" />
  				...
  				<ul>
  					<li class="extra-r">
  					   <div class="regist-link">
                                <asp:Button ID="LogintoReg" runat="server" Text="立即注册" 
                                    class="btn-img btn-entry" TabIndex="6" style="font-weight:bold;" 
                                    onclick="LogintoReg_Click" />
