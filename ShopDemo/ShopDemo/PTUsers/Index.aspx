<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="ShopDemo.PTUsers.Index" %>
...
<header id="pc-header">
    ...
    <div class="BHeader" >
        <div class="yNavIndex">
            <ul class="BHeaderl">
                ...
                <li>
            <asp:Button ID="toReg" runat="server" Text="免费注册"  
                        style="color:#ea4949; border:none; background-color:#f5f5f5;" 
                        onclick="toReg_Click" /> 

                <!--<a href="/PTUsers/Register.aspx">免费注册</a> --></li>
                <li class="headerul">|</li>
                <li><a href="/PTUsers/PurchasePro/MyOrders.aspx">我的订单</a> </li>
                <li class="headerul">|</li>
    ...
    <div class="container clearfix">
        <div class="header-logo fl"><h1><a href="Index.aspx"><img src="../theme/icon/logo.png"></a> </h1></div>
    ...
    <div class="yHeader">
        <div class="yNavIndex">
            ...
            <ul class="yMenuIndex">
                ...
                <li><a href="PurchasePro/Category.aspx" target="_self">图书</a></li>
